...
(def foreclosure-warning-messages
...
(def bankruptcy-messages
  ["The party's over. You have run out of dough, and the bank doesn't want to see your face."
   ...
   "oooooooooooooooooooooooooooooooooooooooooooooooooooo. This game is over now."
...
(def repayment-signoff-messages
...
(def transaction-success-messages
...
(def contract-insufficient-goods-messages
...
(def contract-insufficient-funds-messages
...
(def aom-populations
  ["peasants" "villagers" "workers" "citizens" "foreigners"
   "nomads" "malcontents" "refugees" "dissidents" "slaves"])
